# **AVAX PROOF: Advanced Avalanche (Avalanche Subnets)**

Avalanche Subnets are a powerful tool for building and managing decentralized applications within the Avalanche network, and represent an important step forward in the evolution of blockchain technology 🚀
...
### Functions
1. `transfer`   - Allows an account to transfer tokens to another account.
   
2. `approve`   - Allows an account to approve another account to spend tokens on its behalf.

3. `transferFrom`   - Allows an approved spender to transfer tokens from one account to another.
...
## Author and Licence
This project is licenced under metacrafters.io and the author of this project is Konsam Sajan Singh
